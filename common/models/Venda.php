...
class Venda extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['idcomprador', 'idmetodoexpedicao', 'idtipopagamento', 'total', 'nome', 'codigopostal', 'morada', 'pais', 'cidade'], 'required'],
            [['idcomprador', 'idmetodoexpedicao', 'idtipopagamento', 'estadoencomenda'], 'integer'],
            [['total'], 'number'],
            [['datavenda'], 'safe'],
            [['nome'], 'string', 'max' => 150],
