<div class="conversa-form">
    ...
    $form = ActiveForm::begin([
        ...
        'options' => [
            ...
            'class' => 'p-2' // Classe personalizada para o formulário
        ],
    ]); ?>

    <div class="input-details" style="display: relative;">
        <?= $form->field($modelTexto, 'descricao')->textInput([
            'rows' => 3,
            'placeholder' => 'Digite sua mensagem aqui...',  // Defina o texto do placeholder
        ])->label(false) ?>
