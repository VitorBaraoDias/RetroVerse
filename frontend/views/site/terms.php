...
<h5 class="text-center"><strong>READ THE TERMS AND CONDITIONS UNDER DESCRIBED</strong></h5>

    <div class="terms-container-text">
    <h2>1. ACCEPTANCE OF TERMS</h2>
    <p>
        By accessing and using Retroverse, you agree to the Terms and Conditions described on this page, as well as our Privacy Policy.
        These terms govern your use of the site and the services offered, whether as a buyer, seller, or visitor. Please read these terms carefully,
        and if you do not agree with any part, refrain from using the site.
    </p>
    ...
    <p>
        To use our services, as buying and/or selling, you must create an account, providing accurate, updated, and complete information.
        By creating an account, you are responsible for maintaining the security of your password and all activity conducted under your login.
        In case of unauthorized access, please notify us immediately.
    </p>
