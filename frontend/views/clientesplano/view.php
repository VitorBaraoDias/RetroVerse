            ...
            <div class="card w-100 shadow-sm">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-start align-items-center mb-3">
                        <h5 class="mb-0 mr-2"><strong>Plan Description:</strong></h5>
                        <p class="text-muted mb-0"><?= Html::encode($model->plano->descricao) ?></p>
                    </div>
                    <div class="d-flex justify-content-start align-items-center mb-3">
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <p class="text-muted mb-0"><?= Yii::$app->formatter->asDatetime($model->expira, 'long') ?></p>
                    </div>
